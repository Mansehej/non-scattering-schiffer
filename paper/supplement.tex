...
public theorems.  The packaging environment did not include the Lean
toolchain: a fresh pinned-toolchain kernel build, with its log and axiom
report archived, remains a pre-publication gate, and until then no claim
stronger than ``source scan'' is made.
